            ...
            <div className="hero bg-base-200 min-h-screen">
                <div className="card bg-base-100 w-full mx-5 md:w-1/3 shadow-2xl">
                    ...
                    <div className="flex justify-center items-center">
                        <button className="btn w-full rounded-full md:w-11/12 mx-10 mb-5">Continue with <span><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 48 48">
